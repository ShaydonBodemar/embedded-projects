...
#define SAMPLE_BYTES			0x04		// number of bytes per sample
#define SAMPLE_TICKS			100			// sample period (msec)
#define SHAKE_THRESHOLD			1600		// shake detection threshold
#define TILT_THRESHOLD			11			// X,Y accel threshold (30 deg)
...
void AccelClock(void)
{
	...
	// Hysteresis added by not checking for equality to the threshold
	switch(TiltUpState)
	{
